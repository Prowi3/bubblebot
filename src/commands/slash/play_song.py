...
class PlaySong(commands.Cog):
    ...
    async def play_song(self, ctx: discord.ApplicationContext,
                        url: str,
                        channel: discord.Option(discord.ChannelType, description="Select the Voice Channel that you want to play the song", channel_type=discord.ChannelType.voice) = None, 
